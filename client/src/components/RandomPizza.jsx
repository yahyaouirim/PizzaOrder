            ...
            <form className=' text-primary  mx-auto mt-5 mb-3 rounded-3 p-4 gap-3' style={shadow} onSubmit={submitHandler}>
                ...
                <Row>
                    ...
                    <Col sm={12} md={6}>
                        ...
                        <Row md={6}>
                            {/* <input class="form-check-input" type="checkbox" value="Pineapple" name="Pineapple" /> */}
                            <input
                                className="form-check-input"
                                type="checkbox"
                        ...
                        <Row md={6}>
                            {/* <input className="form-check-input" type="checkbox" value="Extracheese" name="Extracheese" /> */}
                            <input
                                className="form-check-input"
                                type="checkbox"
                    ...
                    <Col sm={12} md={6}>
                        <Row md={6} >
                            {/* <input className="form-check-input" type="checkbox" value="Olives" name="Oloves" /> */}
                            <input
                                className="form-check-input"
                                type="checkbox"
                        ...
                        <Row md={6}>
                            {/* <input class="form-check-input" type="checkbox" value="Sausage" name="Sausage" /> */}
                            <input
                                className="form-check-input"
                                type="checkbox"
